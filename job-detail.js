...
(function() {
  ...
  const AGENCY_SLUG = 'YOUR_AGENCY_SLUG'; // Replace with your Loxo agency slug
  const BEARER_TOKEN = 'YOUR_BEARER_TOKEN'; // Replace with your Loxo bearer token or use environment variables
